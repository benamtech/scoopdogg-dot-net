      ...
      <section className="bg-forest py-20 md:py-24">
        <div className="max-w-site mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/book"
              className="bg-amber hover:bg-amber-hover text-dark font-semibold px-8 py-3.5 rounded-full text-sm transition-all duration-200 hover:scale-[1.02] hover:shadow-lg"
            >
