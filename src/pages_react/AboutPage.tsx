          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  to="/book"
                  className="inline-flex items-center justify-center bg-amber hover:bg-amber-hover text-dark font-semibold px-7 py-3.5 rounded-full transition-all hover:scale-[1.02] hover:shadow-md"
                >
                  Book Service
                </Link>
                <a
      ...
      <section className="py-20 md:py-24 bg-forest">
        <div className="max-w-site mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/book"
              className="inline-flex items-center justify-center bg-amber hover:bg-amber-hover text-dark font-semibold px-8 py-4 rounded-full transition-all hover:scale-[1.02] hover:shadow-lg"
            >
              Book Online
            </Link>
            <a
