...
const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    before: {
      src: '/img/backyard-before.jpg',
      alt: 'Backyard before cleanup',
    },
    after: {
      src: '/img/backyard-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/backyard-section-before.jpg',
      alt: 'Backyard section before cleanup',
    },
    after: {
      src: '/img/backyard-section-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/paved-dog-run-before.jpg',
      alt: 'Paved dog run before cleanup',
    },
    after: {
      src: '/img/paved-dog-run-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/grass-dog-run-before.jpg',
      alt: 'Grass dog run before cleanup',
    },
    after: {
      src: '/img/grass-dog-run-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/enclosure-before.jpg',
      alt: 'Dog enclosure before cleanup',
    },
    after: {
      src: '/img/enclosure-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/small-section-before.jpg',
      alt: 'Small yard section before cleanup',
    },
    after: {
      src: '/img/small-section-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/walkway-before.jpg',
      alt: 'Walkway before cleaning',
    },
    after: {
      src: '/img/walkway-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/turf1-before.jpg',
      alt: 'Artificial turf before treatment',
    },
    after: {
      src: '/img/turf2-after.jpg',
  ...
  },
  {
    ...
    before: {
      src: '/img/gravel-sand-yard-before.jpg',
      alt: 'Overgrown hedges before trimming',
    },
    after: {
      src: '/img/gravel-sand-yard-after.jpg',
  ...
  return (
    ...
    >
      ...
      <div className="mt-4">
        ...
        <h2 className="font-serif text-xl text-dark mb-2 leading-snug">{item.title}</h2>
      ...
      <section className="bg-forest py-16 md:py-20">
        <div className="max-w-site mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/book"
              className="inline-flex items-center justify-center gap-2 bg-amber hover:bg-amber-hover text-dark font-semibold px-8 py-4 rounded-full transition-all hover:scale-[1.02] hover:shadow-[0_6px_24px_rgba(244,160,36,0.45)]"
            >
