            ...
            <div className="min-w-0">
              ...
              <div className="mt-12 bg-forest rounded-2xl p-8 md:p-10">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link
                    to="/book"
                    className="inline-flex items-center justify-center gap-2 bg-amber hover:bg-amber-hover text-dark font-semibold px-7 py-3.5 rounded-full transition-all hover:scale-[1.02] hover:shadow-lg"
                  >
            ...
            <aside className="hidden lg:block">
              <div className="sticky top-28 space-y-8">
                ...
                <div className="bg-forest rounded-2xl p-5 text-center">
                  ...
                  <Link
                    to="/book"
                    className="block bg-amber hover:bg-amber-hover text-dark font-semibold py-3 px-5 rounded-full transition-all text-sm hover:scale-[1.02]"
                  >
                    Book in 60 Seconds
                  </Link>
                </div>
