...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const error = res.ok ? null : new Error((await res.json().catch(() => ({}))).error || 'failed');
        ...
        <div className="max-w-site mx-auto px-4 sm:px-6">
          <div className="max-w-2xl mx-auto">
            <div className="bg-amber/5 border-l-4 border-amber rounded-r-2xl p-8 text-center shadow-sm">
              ...
              <Link
                to="/book"
                className="inline-flex items-center justify-center gap-2 bg-amber hover:bg-amber-hover text-dark font-semibold text-lg px-10 py-4 rounded-full transition-all hover:scale-[1.02] hover:shadow-lg w-full sm:w-auto"
              >
                ...
                {formState === 'success' ? (
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <button
                      ...
                      className="w-full bg-amber hover:bg-amber-hover text-dark font-semibold py-4 rounded-full transition-all hover:shadow-md disabled:opacity-60 flex items-center justify-center gap-2"
                    >
