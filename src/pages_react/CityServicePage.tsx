...
export default function CityServicePage({ city: cityProp, service: serviceProp }: { city?: string; service?: string } = {}) {
  const params = useParams<{ city: string; service: string }>();
  const citySlug = cityProp ?? params.city;
  const serviceSlug = serviceProp ?? params.service;
